...
<?php foreach ($users as $user): ?>
    <div class="profile-card">
        ...
        <div class="profile-back" style="background-color: rgb(19,64,224);"></div><img class="rounded-circle profile-pic" src="<?php echo 'images/' . $user['profile_image'] ?>" width="90" height="90" alt="">
        
        <h4 ><a href="form.php">Editar Perfil</a></h4>
        <h3 class="profile-name" style="background-color: #1340e0;"><?php echo $user ['nombre']; echo $user ['apellido']?></h3>
