  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p><strong>Language:</strong> <?php echo $audio?> </p>
        <p><strong>Gender: </strong> <?php echo $genero?> </p>
        <button type="button" style="border-radius: 25px;" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Comment</button>
        <form>
...
<p class="float-left h3">YOU MAY ALSO LIKE</p><br><br><br>
<table>
    <?php
        ...
        <figure class="snip1527" style="border-radius: 25px; height: 400px; width: 300px;" >
          <div class="image">
            <img src="<?php echo '.././assets/img/ ' .
              ...
              <button  style="border-radius: 25px;" type="button" class="btn btn-info btn-sm"  >See more</button></a>
              </a>
            </div>
              </div>
        </figure>
