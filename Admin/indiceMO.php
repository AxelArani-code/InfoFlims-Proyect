<?php include_once 'php/processFormsMO.php';
...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="./Page/MostRecentAd.php">
      ...
      <div class="col-md-8">
        ...
        <div class="form-row">
          <div class="col-sm-12 col-md-7">
            <div class="form-group"><label>Titulo</label><input class="form-control" type="text" name="titles"></div>
          </div>
        </div>
