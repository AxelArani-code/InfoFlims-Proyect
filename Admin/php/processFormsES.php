  ...
  if (isset($_POST['save_profile'])) {
    ...
    if (empty($error)) {
      if(move_uploaded_file($_FILES["imagenes"]["tmp_name"], $target_file)) {
        $sql = "UPDATE  estrenos SET imagenes='$profileImageName' , title='$title', trailer='$trailer', dates='$dates', descriptions='$descriptions', genero='$genero',audio='$audio' WHERE info_id='$id'";
